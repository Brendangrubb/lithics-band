 ...
 */
function lithicstheme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['lithicstheme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('lithicstheme sample setting'),
  '#default_value' => theme_get_setting('lithicstheme_example'),
